...
class CancelRSVP extends StatefulWidget {
  ...
  @override
  _CancelRSVPState createState() => _CancelRSVPState(event: event);
}

class _CancelRSVPState extends State<CancelRSVP> {
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Text(
                  "Let others know why you couldn’t make it",
                  textAlign: TextAlign.center,
                  style: TextStyle(
