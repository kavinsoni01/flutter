...
class DiscoverDetails extends StatefulWidget {
  ...
  @override
  _DiscoverDetailsState createState() =>
      _DiscoverDetailsState(event: this.event);
}
  ...
  void onCancelRSVPPressed(BuildContext context) {
    ...
    showDialog(
        ...
        builder: (BuildContext context) => CupertinoAlertDialog(
              title: new Text("You're Going"),
              content: new Text(event.title + "On " + event.event_date),
              actions: <Widget>[
          ...
          actions: <Widget>[
            ...
            CupertinoActionSheetAction(
              ...
              onPressed: () {
                ...
                // Navigator.push(context, MaterialPageRoute(builder: (context) => CancelRSVP(event:this.event)));
                Navigator.push(
                    context,
                    MaterialPageRoute(
                    ...
                    Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          //   child:
                          //   Image.network(
                          //      event.imagesModel[0].image,fit: BoxFit.fitHeight,
                          //     height: 420,
                          //   )
                          //   // Image.asset(
                                  ...
                                  children: [
                                                                  ...
                                                                  actions: <
                                                                    ...
                                                                    CupertinoDialogAction(
                                                                      onPressed:
                                                                        ...
                                                                        Navigator.push(
                                                                            context,
                                                                            MaterialPageRoute(builder: (context) => GroupFinderChat())),
                                                                        // callCheckInEventData(),
                                                                      },
                                                                      child:
                                                                          Text(
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        //     padding: EdgeInsets.all(0),
                                        //     onPressed: () => this.onCheckInPressed(context),
                                        //     child: Text(
                                        //           "CHECK IN",
                                        //            textAlign: TextAlign.center,
                                        //            style: TextStyle(),
