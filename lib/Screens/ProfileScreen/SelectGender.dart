...
class SelectGender extends StatefulWidget {
  ...
  // SelectGender({@required this.signupModel, this.alldata});
...
class _SelectGenderState extends State<SelectGender> {
  ...
  void initState() {
    ...
    if (this.genderModel == null) {
      this.genderModel.isMale = 0;
      this.genderModel.isLGBTQ = 0;
    }
  }
...
//
  Widget continueButton() {
    return RaisedButton(
      ...
      onPressed: () {
        ...
        Navigator.pop(context, genderModel); //== 0 ? 'Male' : 'Women'
      },
  ...
  Widget setLGBTQButton() {
    return RaisedButton(
      color: genderModel.isLGBTQ == 1
          ? SmartUtils.blueBackground
          : SmartUtils.themeGrayColor,
      onPressed: () {
        if (genderModel.isLGBTQ == 0) {
          genderModel.isLGBTQ = 1;
        } else {
          genderModel.isLGBTQ = 0;
        }
  ...
  Widget womanButton() {
    return RaisedButton(
      color: genderModel.isMale == 1
          ? SmartUtils.blueBackground
          : SmartUtils.themeGrayColor,
      onPressed: () {
        genderModel.isMale = 1;
        setState(() {});
      },
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(80.0)),
      padding: const EdgeInsets.all(0.0),
