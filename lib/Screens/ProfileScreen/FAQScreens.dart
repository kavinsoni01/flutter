...
class FAQScreens extends StatefulWidget {
  @override
  _FAQScreensState createState() => _FAQScreensState();
}
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: SingleChildScrollView(
                      child: Text(
                        removeAllHtmlTags(faqText.toString()),
                  ...
                  //       _controller.loadUrl(Uri.dataFromString(faqText,
                  //               mimeType: 'text/html',
      ...
      if (response.status == true) {
        ...
        if (this.cmsData.length > 0) {
          this.cmsData.forEach((element) {
            if (element.cms_title == 'FAQ') {
              faqText = element.cms_description;
              // _controller.loadUrl(Uri.dataFromString(faqText,
              //         mimeType: 'text/html',
              //         encoding: Encoding.getByName('utf-8'))
              //     .toString());
