...
class EnterDescription extends StatefulWidget {
  final String stringDesc;

  EnterDescription({@required this.stringDesc});

  @override
  _EnterDescriptionState createState() =>
      _EnterDescriptionState(this.stringDesc);
}

class _EnterDescriptionState extends State<EnterDescription> {
  final String stringDesc;
        ...
        children: <Widget>[
          ...
          Row(
            children: [
              ...
              // Spacer(),
              //           Container(
              //             margin: EdgeInsets.only(right:13,top: 14),
              //             child: GestureDetector(
              //             onTap: () => {
              //                   Navigator.pop(context, txtDescription.text),
              //             },
